/**
 * CUERPO DEL INFORME — lo sirve la app, lo ejecuta el Apps Script del dueño.
 *
 * El dueño no quiere copiar y pegar código cada vez que cambia algo (y tiene
 * razón: no tiene por qué entenderlo). Así que en su planilla vive solo un
 * cargador de treinta líneas, y TODO esto se baja de la app en cada corrida.
 * Cuando el informe cambia, su planilla lo tiene sin que toque nada.
 *
 * Es un IIFE que devuelve la función de entrada: así el cargador la recibe
 * derecho, sin depender de cómo eval() expone las declaraciones.
 */
(function () {
...
// Roboto está en la lista por defecto de Sheets; Inter no, y caía a otra.
var FUENTE = "Roboto";
var PESOS = '"$"#,##0;"- $"#,##0';
var PESOS_USD = '"US$ "#,##0';
var PCT = "0%;-0%";
