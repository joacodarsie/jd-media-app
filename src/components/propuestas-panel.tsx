...
import { Copy, Check, Eye, Sparkles, Trash2, Loader2, ImagePlus, X } from "lucide-react";
...
import { NuevaPropuesta } from "@/components/nueva-propuesta";
...
export function PropuestasPanel({
  ...
  return (
    <div className="space-y-5">
      {/* Alta: el formulario por pasos vive en su propio componente. Lo que se
          carga acá decide la calidad de la propuesta, así que pide en orden
          quién es, qué le llevamos y el contexto real de la reunión. */}
      <NuevaPropuesta rubros={rubros} packs={packs} />
